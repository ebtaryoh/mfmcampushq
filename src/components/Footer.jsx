        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-12 lg:gap-8 mb-24">
          ...
          <div className="lg:col-span-2 pr-8">
            ...
            <div className="flex gap-4">
              ...
              <a href="https://t.me/mfmcampushq" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full border border-white/20 flex items-center justify-center text-white hover:bg-[#229ED9] hover:border-[#229ED9] transition-colors">
