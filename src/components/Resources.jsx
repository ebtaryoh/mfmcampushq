...
export default function Resources() {
  ...
  return (
    <section id="resources" className="py-24 bg-[#f9f5ef]">
      <div className="max-w-[1400px] mx-auto px-6">
        <div className="grid md:grid-cols-3 gap-8">
          {resources.map((item, i) => (
            <FadeUp key={i} delay={0.1 * i} className="h-full">
              <div className="bg-white rounded-[40px] p-10 shadow-sm border border-mfm-stone/10 h-full flex flex-col group hover:shadow-xl hover:-translate-y-2 transition-all duration-300">
                ...
                <p className="text-mfm-stone text-lg leading-relaxed mb-12 flex-1">
                  {item.desc}
                </p>
                
                <a href="#" className="inline-flex items-center gap-2 font-bold text-mfm-purple-dark group-hover:text-mfm-purple transition-colors">
