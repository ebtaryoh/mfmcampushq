    ...
    <section id="about" className="py-32 bg-[#fcfaf7] relative overflow-hidden">
      ...
      <div className="max-w-[1400px] mx-auto px-6 relative z-10">
        <div className="grid lg:grid-cols-2 gap-16 lg:gap-24 items-center">
          ...
          <div>
            <FadeUp>
              <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full border border-mfm-purple/20 text-mfm-purple font-mono text-xs tracking-widest uppercase mb-8 bg-white/50 backdrop-blur-sm">
                About Us
              </div>
            </FadeUp>
            
            <FadeUp delay={0.1}>
              <h2 className="font-display text-4xl md:text-6xl text-mfm-purple-dark mb-8 leading-[1.1]">
                Empowering the next generation of spiritual leaders.
              </h2>
            </FadeUp>
            
            <FadeUp delay={0.2}>
              <p className="text-lg text-mfm-stone mb-6 leading-relaxed font-light">
            ...
            <FadeUp delay={0.3}>
              <p className="text-lg text-mfm-stone mb-12 leading-relaxed font-light">
            ...
            <FadeUp delay={0.4}>
              <div className="grid sm:grid-cols-2 gap-6">
                <div className="bg-white px-8 py-6 rounded-[24px] border border-mfm-stone/10 shadow-sm hover:shadow-md transition-all group">
                  ...
                  <p className="text-mfm-purple-dark font-display text-xl mb-2">Our Mission</p>
                  <p className="text-mfm-stone text-sm leading-relaxed">To propagate the gospel and raise spiritual giants on campuses.</p>
                </div>
                
                <div className="bg-white px-8 py-6 rounded-[24px] border border-mfm-stone/10 shadow-sm hover:shadow-md transition-all group">
                  <div className="w-12 h-12 bg-mfm-purple/10 rounded-xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform">
                    <Eye className="text-mfm-purple" size={24} />
                  </div>
                  <p className="text-mfm-purple-dark font-display text-xl mb-2">Our Vision</p>
                  <p className="text-mfm-stone text-sm leading-relaxed">A fire-full fellowship in every tertiary institution.</p>
                </div>
              </div>
            </FadeUp>
          </div>
          ...
          <div className="relative">
            <FadeUp delay={0.2} className="relative h-[500px] lg:h-[700px] rounded-[40px] overflow-hidden shadow-2xl border border-mfm-stone/10">
              <img 
